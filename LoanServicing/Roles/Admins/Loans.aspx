<%@ Page Title="" Language="C#" MasterPageFile="~/Roles/Admins/administrator.master" AutoEventWireup="true" CodeFile="Loans.aspx.cs" Inherits="Roles_Admins_Loans" %>
...
<div style="padding: 10px 0px 10px 0px;">
    <asp:DropDownList ID="ddlActive" runat="server"
        ...
        <asp:ListItem Text="Open Loans" Value="false" Selected="True"></asp:ListItem>
        <asp:ListItem Text="Closed Loans" Value="true"></asp:ListItem>
    </asp:DropDownList>
</div>
<asp:ObjectDataSource ID="odsLoans" runat="server"
    ...
    TypeName="LoansBLL">
    <SelectParameters>
        <asp:ControlParameter ControlID="ddlActive" Name="Closed" Type="Boolean" PropertyName="SelectedValue" />
    </SelectParameters>
</asp:ObjectDataSource>
    <asp:GridView ID="gvLoans" runat="server"
        ...
        Width="75%"
        ShowFooter="true" 
        OnRowDataBound="gvLoans_RowDataBound"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Balance" HeaderText="Balance" DataFormatString="{0:c}" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" />
            <asp:TemplateField>
                <ItemTemplate>
